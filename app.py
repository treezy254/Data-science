...
import memgpt.humans.humans.humans as humans
...
human = "I'm a team manager at this company"
...
if not USE_MEMGPT:
	# In the AutoGen example, we create an Assistant Agent to playthe role of the code
	...
	# In this example, swap this AutoGen agent with a MemGPT agent
